        ...
        return (
            <ScrollView style={{ marginTop: -50, marginBottom: 200 }}>
                <KeyboardAvoidingView behavior='position' keyboardVerticalOffset={260} style={{ marginLeft: 25, marginRight: 25, marginBottom: 0 }}>
                    ...
                    <Icon tvParallaxProperties={undefined} color='rgba(255,255,255,0.15)' containerStyle={{ alignSelf: 'center', margin: 20 }} style={{}} name="lock" iconStyle={{ color: 'white', alignSelf: 'center' }} size={50} reverse />
